...
> ⚡ Результат за ~1 мс даже на словаре в десятки гигабайт. Работает оффлайн — без GPU и RAM-кеширования.
...
> Каждому файлу соответствует определённый `chunkIndex`. Количество чанков не ограничено архитектурно — система масштабируется линейно.
